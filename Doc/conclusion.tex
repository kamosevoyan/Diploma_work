...
\item{{\addfontfeatures{FakeBold=2.0}A. R. Mitchell}, The finite element method in partial differential equations, 1977.}
\item{{\addfontfeatures{FakeBold=2.0}R. Courant and D. Hilbert}, Methods of mathematical physics, 1937.}
\item{{\addfontfeatures{FakeBold=2.0}Robert C. Kirby}, A general approach to transforming finite elements, 2018.}
\item{{\addfontfeatures{FakeBold=2.0}Р.З. Даутов, М.М. Карчевский}, Введение в теорию метода конечных элементов, 2004.}
\item{{\addfontfeatures{FakeBold=2.0}А.Н.Тихонов, А.А.Самарский}, Уравнения математической физики, 1951.}
