...
\captionsetup{labelformat=empty}
\caption{Նկար 2.4. Տիրույթի տրոհումը ուղղանկյուն եռանկյունների}
\end{figure}
\newpage
...
\captionsetup{labelformat=empty}
\caption{Նկար 2.5. $\varphi^{ij}$ բազիսային ֆունկցիաների պատկեր։}
\end{figure}
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\textwidth]{images/two_dimensional_basis_1}
\captionsetup{labelformat=empty}
\caption{Նկար 2.6 Տիրույթի եզրի վրա գտնվող բազիսային ֆունկցիա։}
\end{figure}
\newpage
...
\captionsetup{labelformat=empty}
\caption{Նկար 2.7. Տիրույթի եռանկյունաձև տրոհման օրինակ։}
\end{figure}
...
\end{figure}
\newpage
\subsection*{4.2 Պուասոնի հավասարման լուծում շրջանում}
...
\captionsetup{labelformat=empty}
\caption{Նկար 4.2. Գլխավոր համակարգի համախմբում։}
\end{figure}
\newpage
\subsubsection*{Ծրագրային իրականացում}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{images/poisson_equation_on_unit_circle_solution}
\captionsetup{labelformat=empty}
\caption{Նկար 4.1. Պուասոնի հավասարման լուծման գրաֆիկական ներկայացում։}
\end{figure}
\newpage
